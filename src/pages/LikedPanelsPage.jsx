...
function LikedPanelsPage() {
  ...
  useEffect(() => {
    ...
    window.addEventListener('panelsense:liked-panels-updated', refreshLikedPanels);
    return () => window.removeEventListener('panelsense:liked-panels-updated', refreshLikedPanels);
  }, []);
  ...
  return (
    <div className="min-h-screen bg-[var(--bg)] text-[var(--text-primary)]">
      <SEO
        title="Liked Decorative Wall Panels"
        description="Review decorative wall panels saved in your browser and use PanelSense AI when you want more wall panel designs, panel images, and interior panel ideas."
        canonicalPath="/liked"
        noindex
        structuredData={{
          ...
          itemListElement: [
            ...
            { '@type': 'ListItem', position: 2, name: 'Liked panels', item: getCanonicalUrl('/liked') },
          ],
        }}
      />
      <Navbar />
      <main className="mx-auto max-w-7xl px-5 pb-16 pt-32 md:px-8">
        <section className="mb-10 max-w-3xl" aria-labelledby="liked-heading">
          ...
          <h1 id="liked-heading" className="font-syne accent-underline text-4xl font-extrabold leading-tight md:text-6xl">
            Liked Panels
          </h1>
          <p className="mt-8 leading-8 text-[var(--text-secondary)]">
            Your liked decorative wall panels are saved in this browser only. Return to this shortlist while comparing
            modern wall panels, wooden panels, PVC panel designs, and laminate panel designs.
          </p>
        </section>
        ...
        {likedPanels.length ? (
          ...
          <div className="glass-panel mx-auto flex max-w-2xl flex-col items-center justify-center rounded-lg p-10 text-center">
            ...
            <p className="mt-3 text-[var(--text-secondary)]">
              Open a panel and tap the heart, or ask PanelSense AI to create a shortlist.
            </p>
            <Button
              variant="contained"
